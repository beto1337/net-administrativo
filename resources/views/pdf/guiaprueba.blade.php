  ...
  <div class="box-body">
    ...
    <table style="width:100%;margin: 10px 0px 10px 0px;">
      <thead style="background-color:#792929;color:white">
        <tr>
          <th colspan="2" style="padding:10px;border-radius: 0px;FONT-SIZE: x-large;">EVENTO Y DETALLES</th>
        </tr>
      </thead>
      <tbody>
        <tr style="height:25px">
          ...
          <td style="width:50%;text-align: -webkit-right;">CLIENTE:  </td>
          <td> {{cliente($orden->cliente,1)}}</td>
          </tr>
          <tr style="border-style: hidden;">
          <td style="width:50%;text-align: -webkit-right;" >EMAIL:  </td>
          <td> {{cliente($orden->cliente,2 )}}</td>
          </tr>
          <tr style="border-style: hidden;">
          <td style="width:50%;text-align: -webkit-right;" >TELEFONO:  </td>
          <td> {{cliente($orden->cliente,3 )}}</td>
          </tr>

          <tr style="border-style: hidden;">
          <td style="width:50%;text-align: -webkit-right;" >LUGAR DE RECEPCION:  </td>
          <td> {{$orden->recepcion}}</td>
          </tr>

          <tr style="border-style: hidden;">
          <td style="width:50%;text-align: -webkit-right;" >FECHA DE EVENTO:  </td>
          <td>  .....</td>
          </tr>

          <tr style="border-style: hidden;">
          <td style="width:50%;text-align: -webkit-right;" >FECHA DE MONTAJE:  </td>
          <td>  {{formatofecha($orden->desde)}}</td>
          </tr>
          <tr style="border-style: hidden;">
          <td style="width:50%;text-align: -webkit-right;" >FECHA Y HORA DE RECOGIDA:  </td>
          <td>  {{$orden->hasta}}</td>
          </tr>
          <tr>
          </tr>
...
<table style="width:100%;margin: 10px 0px 10px 0px;">
  <thead style="background-color:#792929;color:white">
    <tr>
      <th colspan="2" style="padding:10px;border-radius: 0px;FONT-SIZE: x-large;">RESUMEN</th>
    </tr>
  </thead>
  <tbody>
{{resumen($orden->producto,$orden->cantidad,$orden->cliente,$orden->concepto_descuento,$orden->descuento,$orden->concepto_impuesto,$orden->impuesto)}}
  </tbody>
</table>

<div class="panel panel-danger" style="padding:10px 10px 10px 0px;">
  <div class="panel-heading" style='background-color:#792929;color:white;padding:10px;border-radius: 0px;FONT-SIZE: x-large'>CONDICIONES COMERCIALES</div>
