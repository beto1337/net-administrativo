...
<tr>
	...
	<td>$ {{number_format($valor->total_facturado)}}</td>
</tr>
...
<tr>
	<td>SALDO</td>
	<td>$ {{number_format($valor->total_restante)}}</td>
</tr>
...
<input type="text" onkeyup="format(this)" onchange="format(this)" class="form-control" name="impuesto[]" value="0">
	...
	<div class="form-group">
<button type="submit" class="btn btn-success" name="abono" value="1">Registrar Abono</button>
	</div>
...
{{productos($reserva->producto,$reserva->cantidad,$reserva->cliente)}}
	...
	<div class="col-lg-6">
		<form id="form1" name="form1" role="form" enctype="multipart/form-data" method="POST" action="{{ url('generarguia') }}">
			...
			<div class="form-group">
				<button type="submit" class="btn btn-danger" name="generarfactura" value="1">Generar Factura(pdf)</button>
				<button type="submit" class="btn btn-success" name="generarfactura" value="2">Generar Factura(excel)</button>
...
<button type="submit" class="btn btn-success" name="recoger" value="2">Recoger</button>
